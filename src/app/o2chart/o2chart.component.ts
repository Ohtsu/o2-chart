  ...
  ngOnChanges(changes: {[propertyName: string]: SimpleChange}) {
    ...
    private buildScatterPlot(svgContainer: any, configData:any,dataSetJson: any, svgWidth: number, svgHeight: number): void {
        ...
        let _circle = svgContainer.selectAll("circle")
                ...
                .enter()
                .append("circle")
                .attr("cx",(d:O2ScatterPlotData,i):number => {
                    return _initPosX+d.x;
                })
                .attr("cy",(d:O2ScatterPlotData,i):number => {
                    return (svgHeight -configData.margin.bottom - d.y);
                })
                .attr("r",(d:O2ScatterPlotData,i):number =>{
                    return d.r;
                })
                .style("fill",(d,i) => {
    ...
    private drawSingleLine(o2Common: any,dataSet:any,lineNum:number):void{
        ...
        let _lineInterpolate = configData.line.interpolate;
        let _leftMargin = configData.margin.left;
        let _bottomMargin = configData.margin.bottom;
...
//------------------------------------
    ...
    private drawXAxisLabel(o2Common: any,labelDataSet:any,chartType:string):void{
        ...
        let textElements = grpLabel.append("text")
...
//     private buildTreeMap(svgContainer: any, configData:any,dataSetJson: any, svgWidth: number, svgHeight: number): void {

//         console.log("In  buildTreeMap----------------");
...
//         // let nodes = d3.hierarchy(dataSetJson);

//         // nodes = treemap(nodes);

//         let nodes0 = d3.hierarchy(dataSetJson);

//         let nodes = treemap(nodes0);

//         console.log("nodes nodes.leaves()",nodes,nodes.leaves());

//         let tmap = svgContainer.selectAll("rect")
//                 .data(nodes);
...
//             .attr("x",(d,i) => {
//                     console.log("x---,d,i,d.x",d,i,d.x);
//                     return d.x;
//             })
//             .attr("y",(d,i) => {
//                 console.log("y---,d,i,d.y",d,i,d.y);
//                 return d.y;
//             })
//             .attr("width",(d,i) =>{
//                 console.log("width---,d,i,d.x",d,i,d.x);
//                 return d.dx;
//             })
//             .attr("height",(d,i) =>{
//                 console.log("height---,d,i,d.y",d,i,d.y);
//                 return d.dy;
//             })
